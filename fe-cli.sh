...
docker run --rm -ti -v ${HOME}/.flogo/login/.netrc:/root/.netrc -v $PWD:/src -v $PWD/src/app:/gobuild/src -e GOPATH=/gobuild reldocker.tibco.com/tci/tci-flogo-cli:latest $@
