...
describe("Flogo AzureServiceBus", function () {
    ...
    it("UC1 - App with one TopicSubscriber , Queue Reciever and a PublishActivity", function () {
       ...
       // baseWI.appImplementationPageMethods().clickBackButton();//commented for yogini for tci-2.0
        ...
        if (isFlogoEnterpriseEnabled != 'true') {
            ...
            baseWI.checkTextInLogs("sessionautoqueue");
            baseWI.checkTextInLogs("sessionautotopic");
        }
        else {
            appNames = appName;
    ...
    it("UC2 - App with one TopicSubscriber , Queue Reciever and a PublishActivity for deadletter subscription", function () {
        ...
        var queueNameValue = "\"deadq\"";
        var topicNameValue = "\"deadt\"";
        var messageStringValueTopic = "\"MessageinTopic\"";
        var messageStringValueQueue = "\"MessageinQueue\"";
        //var sessionIdValueQueue = ["\"sessionautoqueue\""];
        //var sessionIdValueTopic = ["\"sessionautotopic\""];
       ...
       // var sessionId = ["SessionId"];
        ...
        baseAzureServiceBus.AzureServiceBusPaletteMethods().createAzureTopicSubscriberDlq("AzureTopicSubscriber","AzureTopicSubscriberdescription","AzureServiceBusConnection","deadt","test2");
       ...
       browser.sleep(1000);
        baseAzureServiceBus.AzureServiceBusPaletteMethods().createAzureQueueRecieverDlq("AzureQueueReceiverSubscriber","AzureQueueReceiverdescription","AzureServiceBusConnection",deadqName);
